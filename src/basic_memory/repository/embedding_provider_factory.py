...
# dimensions, semantic role/input-type/prefix settings, batch/request knobs, and
# the resolved cache dir). Thread/parallel knobs are deliberately excluded - they
